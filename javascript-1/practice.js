...
const total = myNumbers.reduce(function(accum,element,index,array){
...
const totallyAwesome = people.reduce(function(accum,element,array,index){
	return accum + element.awesomeLevel
})
